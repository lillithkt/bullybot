...
const deathReasons = [
  ...
  "<user> got an anvil dropped on its head lmao",
  ...
  "<user> poured water on its electrical breaker",
  "<user> experienced a kami-level event",
  "<user> was caught in a fortnite event",
  "<user> ate chalk",
  "<user> really fucked up its homemade nuclear power plant and has died due to hawking radiation born of a black hole!",
  ...
  "<user> leaned back in its chair a little too much",
  ...
  "<user> had its ceiling fan fall on them",
  ...
  "<user> lost its blue hair and pronounce",
  "<user> forgot",
  ...
  "<user> encountered <@352916345211322380>",
  // blast
  "<user> encountered <@327548816196763650>",
  "<user> encountered <@327548816196763650>",
  "<user> encountered <@327548816196763650>",
  "<user> encountered <@327548816196763650>",
  "<user> encountered <@327548816196763650>",
